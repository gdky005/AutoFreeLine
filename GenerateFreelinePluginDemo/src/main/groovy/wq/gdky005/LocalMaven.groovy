...
def runLocalMaven = { def proDir, def mainModule, def libModule, def gradleProperties ->
...
runLocalMaven(proDir, mainModule, libModule, gradleProperties)
runLocalMaven(proDir, mainModule, lib2Module, gradleProperties)